...
namespace DatabaseLayer
{
    ...
    public partial class JobSeacrhDbEntities : DbContext
    {
        public JobSeacrhDbEntities()
            : base("name=JobSeacrhDbEntities")
        {
        }
        ...
        public virtual DbSet<JobApplysTable> JobApplysTables { get; set; }
